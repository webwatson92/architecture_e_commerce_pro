...
class OnBoardingNextButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Positioned(
      ...
      bottom: TDeviceUtils.getBottolNavigationBarHeight(),
      child: ElevatedButton(
        onPressed: () => OnBoardingController.instance.nextPage(), 
        style: ElevatedButton.styleFrom(shape: const CircleBorder(), backgroundColor: dark ? TColors.primaryColors : Colors.black),
